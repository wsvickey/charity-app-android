...
/**
 * Created by Charitha Ratnayake on 5/24/2018.
 */
...
//    public ArrayList<Link> getListObject(String key, Class<?> mClass){
//    	Gson gson = new Gson();
//
//    	ArrayList<String> objStrings = getListString(key);
//    	ArrayList<Link> objects =  new ArrayList<Link>();
//
//    	for(String jObjString : objStrings){
//            Link value  = (Link) gson.fromJson(jObjString,  mClass);
//    		objects.add(value);
//    	}
//    	return objects;
//    }
...
//    public void putListObject(String key, ArrayList<Link> objArray){
//    	checkForNullKey(key);
//    	Gson gson = new Gson();
